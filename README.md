...
[![](https://img.shields.io/badge/PyQt-5.15-orange)](https://www.qt.io/)
[![](https://img.shields.io/badge/PyQt--Fluent--Widgets-V1.0-blue)](https://github.com/zhiyiYo/PyQt-Fluent-Widgets)
...
一个简单的Steam登录工具，支持跳过邮箱验证（需要正确的SSFN）

</div>

### 注意
此分支不保证能够正常使用，这是一个开发分支，包含大量未测试代码
